...
(
    ...
    company_name     varchar(256)                       null comment '公司全称',
...
(
    ...
    former_name              varchar(1024)                      null comment '曾用名',
    territory                varchar(128)                       null comment '所属地域',
    ...
    controlling_shareholder  varchar(512)                       null comment '控股股东',
    actual_controller        varchar(512)                       null comment '实际控制人',
    ultimate_controller      varchar(512)                       null comment '最终控制人',
    chairman_of_the_board    varchar(128)                       null comment '董事长',
    secretary_to_the_board   varchar(256)                       null comment '董秘',
    corporate_representative varchar(256)                       null comment '法人代表',
    general_manager          varchar(256)                       null comment '总经理',
    registered_capital       varchar(256)                       null comment '注册资金',
    number_of_employees      varchar(10)                        null comment '员工人数',
...
(
    ...
    fax                      varchar(128)                       null comment '传真',
    postcode                 varchar(128)                       null comment '邮编',
    recruitment              text                               null comment '招聘网址JSON格式',
